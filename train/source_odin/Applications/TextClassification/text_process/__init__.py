#-*- coding: utf-8 -*-
from Applications.TextClassification.text_process import cleaners
from jamo import h2j
from itertools import chain
from Applications.TextClassification.text_process import cleaners
from Applications.TextClassification.text_process.symbols import symbols
import string
import numpy as np
from Applications.TextClassification.text_process import cleaners
from jamo import h2j
...
def text_to_sequence(txt, cleaner=['english_cleaners'], lang=0):
...
# txt='간낭종'
# #print(text_to_sequence(txt, cleaner=['english_cleaners'], lang=0))
# # sequence_to_text(text_to_sequence(txt, ['english_cleaners'], lang=0))